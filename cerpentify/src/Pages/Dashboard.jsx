...
export default function Dashboard() {
  return (
    <div style={{ position: "relative", width: "100vw", height: "100vh" }}>
      ...
      <button
        className="fixed bottom-8 right-8 w-20 h-20 rounded-full bg-white shadow-lg flex items-center justify-center z-[200] border border-gray-200 hover:shadow-2xl transition duration-200 transform hover:scale-110 active:scale-95"
